  ...
  IR_data <- function(data,country_name_districts,country_name_sites,country_name_countries) {
    ...
    #for(i in 1:length(unique(data$Insecticide))){
    #  an_1 <- subset(an_1, data$Insecticide == levels(data$Insecticide)[1])
  ...
  ###*** Change the insecticide that you are considering                             ***###  
    data <- subset(data, data$Insecticide == levels(data$Insecticide)[1])
    
  IR_data(data,country_name_districts = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\districts_WHO tube test_An_1_Madagascar_Bendiocarb",
          country_name_sites = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\sites_WHO tube test_An_1_Madagascar_Bendiocarb",
          country_name_countries = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\countries_WHO tube test_An_1_Madagascar_Bendiocarb")

    data <- read.csv("C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\PMI Entomology Data WHO tube test Madagascar.csv",header=TRUE)
    data <- subset(data, data$Insecticide == levels(data$Insecticide)[2])
    
    IR_data(data,country_name_districts = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\districts_WHO tube test_An_1_Madagascar_DDT",
            country_name_sites = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\sites_WHO tube test_An_1_Madagascar_DTT",
            country_name_countries = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\countries_WHO tube test_An_1_Madagascar_DTT")
  
    data <- read.csv("C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\PMI Entomology Data WHO tube test Madagascar.csv",header=TRUE)
    data <- subset(data, data$Insecticide == levels(data$Insecticide)[3])
    
    IR_data(data,country_name_districts = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\districts_WHO tube test_An_1_Madagascar_Deltamethrin",
            country_name_sites = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\sites_WHO tube test_An_1_Madagascar_Deltamethrin",
            country_name_countries = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\countries_WHO tube test_An_1_Madagascar_Deltamethrin")
    
    data <- read.csv("C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\PMI Entomology Data WHO tube test Madagascar.csv",header=TRUE)
    data <- subset(data, data$Insecticide == levels(data$Insecticide)[4])
    
    IR_data(data,country_name_districts = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\districts_WHO tube test_An_1_Madagascar_Fenitrothion",
            country_name_sites = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\sites_WHO tube test_An_1_Madagascar_Fenitrothion",
            country_name_countries = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\countries_WHO tube test_An_1_Madagascar_Fenitrothion")
    
    data <- read.csv("C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\PMI Entomology Data WHO tube test Madagascar.csv",header=TRUE)
    data <- subset(data, data$Insecticide == levels(data$Insecticide)[5])
    
    IR_data(data,country_name_districts = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\districts_WHO tube test_An_1_Madagascar_Lambda-cyhalothrin",
            country_name_sites = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\sites_WHO tube test_An_1_Madagascar_Lambda-cyhalothrin",
            country_name_countries = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\countries_WHO tube test_An_1_Madagascar_Lambda-cyhalothrin")

    data <- read.csv("C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\PMI Entomology Data WHO tube test Madagascar.csv",header=TRUE)
    data <- subset(data, data$Insecticide == levels(data$Insecticide)[8])
    
    IR_data(data,country_name_districts = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\districts_WHO tube test_An_1_Madagascar_Pirimiphos-methyl",
            country_name_sites = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\sites_WHO tube test_An_1_Madagascar_Pirimiphos-methyl",
            country_name_countries = "C:\\Users\\Ellie\\Documents\\Insecticide resistance\\PMI data\\Abt Associates_susceptibility and decay rates\\Data_prepped WHO tube test\\countries_WHO tube test_An_1_Madagascar_Pirimiphos-methyl")
